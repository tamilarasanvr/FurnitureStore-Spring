...
<h4 Style="text-align:right;color:black">Welcome   <%=session.getAttribute("Id")%>!</h4>
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<c:forEach var="AddCartListBean" items="${view}">
					...
					<div class="col-sm-6 col-md-4 col-lg-3 mt-4">
						<div class="w3-card-4 w3-dark-grey"
							...
							<div class="w3-container w3-center">
							 ...
							 <input type="text" value="${AddCartListBean.image}" name="image" style="display: none">
							 <br>
							 
							 <input type="text" style="color: black;display:none" name="userId"   value="<%=session.getAttribute("Id")%>" > 
								...
								<input style="color: black" type="text" name="productName"
									value="${AddCartListBean.productName}" readonly="readonly" /> <br>
								...
								<label> Product Price : <img
									...
									name="price" value="${AddCartListBean.price}" readonly="readonly" />
