	...
	<div class="container">
		...
		<div class="row main">
			<div class="main-login main-center">
				<form class="form-horizontal" action="updateUser.do" method="get" 
					name="register">
					<h1 align="center">
						<i><b>Update Profile</b></i>
					</h1>
					<%-- <h4>${Id.userId}</h4> --%>
					<div class="form-group">
						<label for="username" class="cols-sm-2 control-label">User Id
						</label> <br>
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									placeholder="Enter your Username" value="${view.userName}" required />
							</div>
						</div>
					</div>
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									placeholder="Enter your Door No" value="${view.doorNo}"required />
							</div>
						</div>
					</div>
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									id="street" placeholder="Enter your Street Name" value="${view.street}" required />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-6">
							...
							<select class="form-control form-group"
								...
								name="state" >
<%-- 									<option value="${Id.city}" >${Id.state} </optionvalue>
 --%>								</select>
						</div>
						...
						<div class="col-sm-6">
							<label>City*</label> <select class="form-control form-group"
								name="city" id="state" >
<%-- 								<option value="${view.city}" >${view.city} </optionvalue>
 --%>								</select>
							<script src="state1.js">
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									placeholder="Enter your Pin Code" value="${view.pinCode}"required />
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									pattern="^[987]{1}[0-9]{9}$" placeholder="Enter your Phone No" value="${view.phone}"
									required />
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									name="emailId" id="emailId" placeholder="Enter your Email Id" value="${view.emailId}"
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									id="password" placeholder="Enter your Password" value="${view.password}" required>
							</div>
						</div>
					</div>
					...
					<div class="form-group ">
						...
						<input type="submit" class="btn btn-info" value="Edit"
							...
							<a href="Product.jsp" type="submit" class="btn btn-info" >Back</a>
						</div>
				</form>
			</div>
		</div>
